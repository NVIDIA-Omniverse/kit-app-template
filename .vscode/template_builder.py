...
ALL_EXTS_KIT_PARTIAL_PATH = Path("templates", "omni.all.template.extensions.kit")
...
def _template_new_all(repo_path: Path) -> None:
    ...
    version = "0.1.0"
    commands = (
        f"--input=Application>;[kit_base_editor]: Kit Base Editor;{company}.kit_base_editor;DEFAULT;DEFAULT;DEFAULT;",
        f"--input=Application>;[omni_usd_composer]: USD Composer;{company}.usd_composer;DEFAULT;{version};DEFAULT;DEFAULT;{version};",
        f"--input=Application>;[omni_usd_explorer]: USD Explorer;{company}.usd_explorer;DEFAULT;{version};DEFAULT;DEFAULT;{version};{version};DEFAULT;DEFAULT",
        f"--input=Application>;[omni_usd_viewer]: USD Viewer;DEFAULT;DEFAULT;{version};DEFAULT;DEFAULT;{version};DEFAULT;DEFAULT;{version};{version};{version};DEFAULT;DEFAULT;{version};",
