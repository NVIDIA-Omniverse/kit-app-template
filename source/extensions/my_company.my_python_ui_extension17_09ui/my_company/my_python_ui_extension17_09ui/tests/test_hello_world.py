...
import my_company.my_python_ui_extension17_09ui
...
class Test(omni.kit.test.AsyncTestCase):
    ...
    async def test_hello_public_function(self):
        result = my_company.my_python_ui_extension17_09ui.some_public_function(4)
        self.assertEqual(result, 256)

    async def test_window_button(self):
        # Find a label in our window
        label = ui_test.find("My Python UI Extension17_09ui//Frame/**/Label[*]")

        # Find buttons in our window
        add_button = ui_test.find(
            "My Python UI Extension17_09ui//Frame/**/Button[*].text=='Add'"
        )
        reset_button = ui_test.find(
            "My Python UI Extension17_09ui//Frame/**/Button[*].text=='Reset'"
        )
